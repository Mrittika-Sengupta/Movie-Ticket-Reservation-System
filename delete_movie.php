		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
					...
					<a href="delete_movie.php" class="list-group-item active" style="background-color:#3365FF;color:#ffffff;border-color:#3365FF;">DELETE MOVIE</a>
			...
			<div class="col-md-8">
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="delete.php" class="form-group" method="post">
					...
					<?php
						...
						?>
							<tr>
								...
								<input type ="hidden" name="id" value ="<?php echo $info['movie_id'] ?>">
